    ...
    public void onClick(View view) {
        switch(view.getId()){
            ...
            case R.id.bt_register:
                ...
                if(selectedId==-1){
                    Toast.makeText(Registeration_form.this,"Nothing selected", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(Registeration_form.this,genderradioButton.getText(), Toast.LENGTH_SHORT).show();
                }
                if(Validate()) {
