 ...
 */
public class SjdbcEx3 extends JFrame{
        ...
        b1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    stmt.executeUpdate("Insert into prod(prodid,prodname,price,quantity) values ("+t1.getText()+",' "+t2.getText()+" ',' "+t3.getText()+" ',' "+t4.getText()+ " ')");
        ...
        b2.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/sagar","root","root");
                    Statement stmt=con.createStatement();
                    stmt.executeUpdate("update prod set prodname=' "+t2.getText()+" ',price=' "+t3.getText()+" ',quantity=' "+t4.getText()+ " ' where prodid="+t1.getText()+" ");
        ...
        b3.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/sagar","root","root");
                    Statement stmt=con.createStatement();
                    stmt.executeUpdate("delete from prod where prodid="+t1.getText()+" ");
        ...
        b3.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/sagar","root","root");
                    Statement stmt=con.createStatement();
                    ResultSet rs=stmt.executeQuery("select * from prod where prodid="+t1.getText()+"");
                    int temp=0;
                    while(rs.next()){
                        temp=1;
                    }
