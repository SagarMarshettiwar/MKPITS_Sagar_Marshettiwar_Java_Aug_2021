 ...
 * @author SAGAR
 */
public class SjdbcEx1 extends JFrame{
    JLabel l1,l2,l3;
    JButton b1,b2,b3,b4;
    JTextField tf1;
    JPasswordField pf1;
        ...
        b1.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    String qr=("insert into user(username,password) values(' "+tf1.getText()+" ',' "+pf1.getText()+" ')");
        ...
        b2.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/sagar","root","root");
                    Statement stmt=con.createStatement();
                    String qr=("update user set password=' "+pf1.getText()+ " ' where username=' "+tf1.getText()+" '; ");
                    stmt.executeUpdate(qr);
                    con.close();
                    l3.setText("updated");
                }catch(Exception ee){
        ...
        b3.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/sagar","root","root");
                    Statement stmt=con.createStatement();
                    String qr=("delete from user where username='"+tf1.getText()+"'; ");
                    stmt.executeUpdate(qr);
                    con.close();
                    l3.setText("delete");
                }catch(Exception ee){
        ...
        b4.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/sagar","root","root");
                    Statement stmt=con.createStatement();
                    String qr=("select * from user where username=' "+tf1.getText()+" ' and ' "+pf1.getText()+" ';");
