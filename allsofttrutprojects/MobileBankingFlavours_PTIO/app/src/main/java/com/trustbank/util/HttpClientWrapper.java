...
//            httpURLConnection.setRequestProperty("api_key", apiKey);
    ...
    public static String getcedulaverifyGET(String url, String actionName) {
        ...
        try {
            if (url.contains("http://")) {
                ...
                try {
                    ...
                    httpURLConnection.setConnectTimeout(AppConstants.timeOut);
                    httpURLConnection.setReadTimeout(AppConstants.timeOut);
                    httpURLConnection.setRequestProperty("apikey","dd44827e-9212-4500-bc38-021820f935e5");
                    httpURLConnection.setRequestProperty("action", actionName);
    ...
    public static String getcedulaverifyCreditEligibiltyGET(String url, String postValues) {
