...
public class VisitUsMenu extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(VisitUsMenu.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(VisitUsMenu.this, false);
        setContentView(R.layout.activity_u_p_i_menu);
        ...
        toolbar.setText(R.string.VisitUs);
        inIt();
    }
    ...
    private void inIt() {
        try {
            method = new TrustMethods(VisitUsMenu.this);
    ...
    private void Submenuselectorfund() {
        TrustMethods.Submenuselectorfund(VisitUsMenu.this,recyclerAccounts);
    }
    private void staticData(RecyclerView.LayoutManager mLayoutManager) {
        ...
        FundsTransferAdapter fundsTransferAdapter = new FundsTransferAdapter(VisitUsMenu.this, Arrays.asList(newitemData));
        recyclerAccounts.setAdapter(fundsTransferAdapter);
    }

    @Override
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(VisitUsMenu.this);
    }

    private void horizontalRecyclerView() {
        recyclerViewHoriListId = findViewById(R.id.recyclerViewHoriListId);
        method.horizontalRecyclerView(VisitUsMenu.this, recyclerViewHoriListId);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.backButton_new:
                Intent intent = new Intent(VisitUsMenu.this, MenuActivity.class);
            ...
            case R.id.scan:
                ...
                Intent intent1 = new Intent(VisitUsMenu.this, SelfTransferToAccountActivity.class);
