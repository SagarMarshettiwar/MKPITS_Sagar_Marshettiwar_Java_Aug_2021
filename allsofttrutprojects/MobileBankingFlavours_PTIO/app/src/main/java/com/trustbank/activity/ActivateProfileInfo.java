    ...
    private void registerEvent() {
        btnProfileNextId.setOnClickListener(view -> {
            ...
            if (TextUtils.isEmpty(etFullName.getText().toString())) {
                ...
                TrustMethods.showSnackBarMessage(getResources().getString(R.string.msg_enter_email), coordinatorLayout);
            } else {
                ...
                String emailId = etEmailId.getText().toString().trim();
                    if (!TextUtils.isEmpty(emailId)) {
                        ...
                        if (!isValidEmail) {
                            TrustMethods.showSnackBarMessage(getResources().getString(R.string.Please_enter_valid_email_id), coordinatorLayout);
                            return;
                        }
                    }
                    ...
                    if (TrustMethods.isSimAvailable(getApplicationContext()) && TrustMethods.isSimVerified(ActivateProfileInfo.this)) {
                        if (NetworkUtil.getConnectivityStatus(ActivateProfileInfo.this)) {
                            if (!TextUtils.isEmpty(AppConstants.getServerOtp())) {
                                ...
                                TrustMethods.showSnackBarMessage(getResources().getString(R.string.Entered_Otp_is_invalidplease_enter_correct_Otp), coordinatorLayout);
                            }
                        } else {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                if (responseCode.equals("1")) {
                    response = getResources().getString(R.string.UserSuccessfullyRegistered);
                } else {
