...
public class MBank extends Application {
    ...
    public void onCreate() {
        ...
        if (BuildConfig.DEBUG) {
            ...
            if(getPackageName().equalsIgnoreCase("com.trustbank.abc")){
                AppConstants.isAutoReadOTPReadOnlyRegisterMobile = true; //ptio only Set True for enabling Auto Read OTP using SMS Retrieval Api (false - OFF for Shivaji bank,VMUCB)
            }else{
                AppConstants.isAutoReadOTPReadOnlyRegisterMobile = false; //ptio only Set True for enabling Auto Read OTP using SMS Retrieval Api (false - OFF for Shivaji bank,VMUCB)
            }
