...
public class TransactionMenu extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(TransactionMenu.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(TransactionMenu.this, false);
        setContentView(R.layout.activity_need_help);
        trustMethods =new TrustMethods(TransactionMenu.this);
        ...
        toolbar.setText(R.string.Transactions);
    ...
    private void inIt() {
        try {
            ...
            method = new TrustMethods(TransactionMenu.this);
    ...
    private void Submenuselectorfund() {
        TrustMethods.Submenuselectorfund(TransactionMenu.this,recyclerAccounts);
    }
    private void staticData(RecyclerView.LayoutManager mLayoutManager) {
        ...
        FundsTransferAdapter fundsTransferAdapter = new FundsTransferAdapter(TransactionMenu.this, Arrays.asList(newitemData));
    ...
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(TransactionMenu.this);
    }

    private void horizontalRecyclerView() {
        recyclerViewHoriListId = findViewById(R.id.recyclerViewHoriListId);
        trustMethods.horizontalRecyclerView(TransactionMenu.this, recyclerViewHoriListId);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.backButton_new:
                Intent intent = new Intent(TransactionMenu.this, MenuActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
                break;
            ...
            case R.id.scan:
                ...
                Intent intent1 = new Intent(TransactionMenu.this, SelfTransferToAccountActivity.class);
