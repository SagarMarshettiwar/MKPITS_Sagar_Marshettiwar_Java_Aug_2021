...
public class SaveMenu extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(SaveMenu.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(SaveMenu.this, false);
        setContentView(R.layout.activity_locate_us);
        trustMethods=new TrustMethods(SaveMenu.this);
    ...
    private void inIt() {
        ...
        try {
            method = new TrustMethods(SaveMenu.this);
    ...
    private void Submenuselectorfund() {
        TrustMethods.Submenuselectorfund(SaveMenu.this,recyclerAccounts);
    }
    private void staticData(RecyclerView.LayoutManager mLayoutManager) {
        ...
        FundsTransferAdapter fundsTransferAdapter = new FundsTransferAdapter(SaveMenu.this, Arrays.asList(newitemData));
   ...
   /* @Override
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.backButton_new:
                Intent intent = new Intent(SaveMenu.this, MenuActivity.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
                break;
            ...
            case R.id.scan:
                ...
                Intent intent1 = new Intent(SaveMenu.this, SelfTransferToAccountActivity.class);
    ...
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(SaveMenu.this);
    }

    private void horizontalRecyclerView() {
        recyclerViewHoriListId = findViewById(R.id.recyclerViewHoriListId);
        trustMethods.horizontalRecyclerView(SaveMenu.this, recyclerViewHoriListId);
    }
