...
public class ChangePINSActivity extends AppCompatActivity implements AlertDialogOkListener, View.OnClickListener {
    ...
    private TextView toolbar, txtoldTpin, txtnewPinId, txtConfrimPINId;
    ...
    private void inicomponent() {
        ...
        txtoldTpin = findViewById(R.id.txtoldTpin);
        txtnewPinId = findViewById(R.id.txtnewPinId);
        txtConfrimPINId = findViewById(R.id.txtConfrimPINId);
        ...
        if (intent.hasExtra("formType")) {
            ...
            if (!TextUtils.isEmpty(formType)){
                if (formType.equalsIgnoreCase("changeTpin")) {
                    toolbar.setText(R.string.txt_change_tpin);
                    txtoldTpin.setText(R.string.hint_old_tpin);
                    txtnewPinId.setText(R.string.hint_new_tpin);
                    txtConfrimPINId.setText(R.string.hint_confirm_tpin);

                    etoldTpin.setHint(getResources().getString(R.string.hint_old_tpin));
                    etnewPinId.setHint(getResources().getString(R.string.hint_new_tpin));
                    etConfrimPINId.setHint(getResources().getString(R.string.hint_confirm_tpin));

                } else if (formType.equalsIgnoreCase("changeMpin")) {
                    toolbar.setText(R.string.txt_change_mpin);
                    txtoldTpin.setText(R.string.hint_old_mpin);
                    txtnewPinId.setText(R.string.hint_new_mpin);
                    txtConfrimPINId.setText(R.string.hint_confirm_mpin);

                    etoldTpin.setHint(getResources().getString(R.string.hint_old_mpin));
                    etnewPinId.setHint(getResources().getString(R.string.hint_new_mpin));
                    etConfrimPINId.setHint(getResources().getString(R.string.hint_confirm_mpin));
                }
            }
        }
    ...
    private class ChangeTpinAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        public ChangeTpinAsyncTask(Context ctx, String strOldPin, String strNewPIN, String strConfirmPin) {
            this.ctx = ctx;
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                if (responseCode.equals("1")) {
                    ...
                    response = getResources().getString(R.string.Tpinch);
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                if (responseCode.equals("1")) {
                    ...
                    response = getResources().getString(R.string.MPinChangedSuccessfully);
    ...
    public void onClick(View view) {
        Intent intent = new Intent(ChangePINSActivity.this, SecurityCenterActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(intent);
        finish();
    }
