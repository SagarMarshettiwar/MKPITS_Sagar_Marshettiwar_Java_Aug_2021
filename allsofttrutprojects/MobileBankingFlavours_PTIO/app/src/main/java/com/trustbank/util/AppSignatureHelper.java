...
public class AppSignatureHelper extends ContextWrapper {
    ...
    public ArrayList<String> getAppSignatures(Context context) {
        ...
        try {
            ...
            for (Signature signature : signatures) {
                String hash = hash(packageName, signature.toCharsString(), context);
                if (hash != null) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    private static String hash(String packageName, String signature, Context context) {
