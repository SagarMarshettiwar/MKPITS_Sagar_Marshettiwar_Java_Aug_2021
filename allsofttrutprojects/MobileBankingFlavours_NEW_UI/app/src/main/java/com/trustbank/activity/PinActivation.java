...
public class PinActivation extends AppCompatActivity implements AlertDialogListener {
    ...
    private void initcomponent() {
        try {
            ...
            session = new SessionManager(PinActivation.this);
            ...
            if(AppConstants.four_digit_pin_enable){
                etMPin.setFilters(new InputFilter[] { new InputFilter.LengthFilter(4) });
                etConfrimMPIN.setFilters(new InputFilter[] { new InputFilter.LengthFilter(4) });
            }else{
                etMPin.setFilters(new InputFilter[] { new InputFilter.LengthFilter(6) });
                etConfrimMPIN.setFilters(new InputFilter[] { new InputFilter.LengthFilter(6) });
            }
            ...
            etSecurityCode.setCustomSelectionActionModeCallback(new   ActionMode.Callback() {
            ...
            etMPin.setCustomSelectionActionModeCallback(new   ActionMode.Callback() {
                public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
                    return false;
                }
            ...
            etConfrimMPIN.setCustomSelectionActionModeCallback(new   ActionMode.Callback() {
                public boolean onPrepareActionMode(ActionMode mode, Menu menu) {
                    return false;
                }
        ...
        btnActivation.setOnClickListener(view -> {
            ...
            if (AppConstants.four_digit_pin_enable) {
                ...
                if (textInputCustId.getVisibility() == View.VISIBLE && TextUtils.isEmpty(etClientId.getText().toString())) {
                    ...
                    TrustMethods.showSnackBarMessage(getResources().getString(R.string.error_mismatch_mpin), coordinatorLayoutPin);
                } else if (etMPin.getText().toString().length() != 6 || etConfrimMPIN.getText().toString().length() != 6) {
    ...
    private class PinActivationAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String value) {
            ...
            if (!this.error.equals("")) {
                ...
                if (response != null) {
                    if(AppConstants.getShow_tpin().equals("1")) {
                        session.createLoginSession(AppConstants.getUSERMOBILENUMBER(), mClientId);
                        clearAllFields();
    ...
    private class SecurityCodeAddValidationAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                String profileId = method.getProfileId(PinActivation.this);
        ...
        protected void onPostExecute(String value) {
            ...
            try {
                ...
                if (!this.error.equals("")) {
                    ...
                    intent.putExtra("FromActivity", "PinActivation");
