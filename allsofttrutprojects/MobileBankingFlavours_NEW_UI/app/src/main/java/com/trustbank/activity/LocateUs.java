...
public class LocateUs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(LocateUs.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(LocateUs.this, false);
        setContentView(R.layout.activity_locate_us);
        trustMethods=new TrustMethods(LocateUs.this);
        inIt();
    }
    ...
    private void inIt() {
        ...
        try {
            ...
            method = new TrustMethods(LocateUs.this);
    ...
    private void Submenuselectorfund() {
        TrustMethods.Submenuselectorfund(LocateUs.this,recyclerAccounts);
    }
    private void staticData(RecyclerView.LayoutManager mLayoutManager) {
        ...
        FundsTransferAdapter fundsTransferAdapter = new FundsTransferAdapter(LocateUs.this, Arrays.asList(newitemData));
    ...
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(LocateUs.this);
    }

    private void horizontalRecyclerView() {
        recyclerViewHoriListId = findViewById(R.id.recyclerViewHoriListId);
        trustMethods.horizontalRecyclerView(LocateUs.this, recyclerViewHoriListId);
    }
}