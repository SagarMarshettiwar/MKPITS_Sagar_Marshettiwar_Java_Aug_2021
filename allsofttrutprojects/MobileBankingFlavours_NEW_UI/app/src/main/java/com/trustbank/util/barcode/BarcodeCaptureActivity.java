...
import com.trustbank.util.camera.CameraSourcePreview;
...
public class BarcodeCaptureActivity extends AppCompatActivity implements BarcodeTracker.BarcodeGraphicTrackerCallback {
    ...
    private com.trustbank.util.camera.CameraSource mCameraSource;
    ...
    public void onDetectedQrCode(Barcode barcode) {
        if (barcode != null) {
            ...
            intent.putExtra(BarcodeObject, (Parcelable) barcode);
