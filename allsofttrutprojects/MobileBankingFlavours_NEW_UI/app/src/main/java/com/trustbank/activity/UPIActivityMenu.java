...
public class UPIActivityMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(UPIActivityMenu.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(UPIActivityMenu.this, false);
    ...
    private void inIt() {
        try {
            ...
            method = new TrustMethods(UPIActivityMenu.this);
    ...
    private void Submenuselectorfund() {
        TrustMethods.Submenuselectorfund(UPIActivityMenu.this,recyclerAccounts);
    }
    private void staticData(RecyclerView.LayoutManager mLayoutManager) {
        ...
        FundsTransferAdapter fundsTransferAdapter = new FundsTransferAdapter(UPIActivityMenu.this, Arrays.asList(newitemData));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(UPIActivityMenu.this, MenuActivity.class);
    ...
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(UPIActivityMenu.this);
    }

    private void horizontalRecyclerView() {
        recyclerViewHoriListId = findViewById(R.id.recyclerViewHoriListId);
        method.horizontalRecyclerView(UPIActivityMenu.this, recyclerViewHoriListId);
    }
}