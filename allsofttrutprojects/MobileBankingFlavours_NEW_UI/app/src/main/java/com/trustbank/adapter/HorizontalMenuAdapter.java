...
public class HorizontalMenuAdapter extends RecyclerView.Adapter<HorizontalMenuAdapter.ViewHolder> {
    ...
    private ArrayList<ImageTextMenuModel> itemsData;
    HashMap<String, List<DynamicMenuModel>> bottomsubmenumap;
    Activity mActivity;
    TrustMethods trustMethods;

    public HorizontalMenuAdapter(Activity activity, ArrayList<ImageTextMenuModel> itemsData, HashMap<String, List<DynamicMenuModel>> bottomsubmenumap) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            switch (itemsData.get(getAdapterPosition()).getItemName().trim()) {
                ...
                case "Accounts":
                    if (bottomsubmenumap.containsKey("mnu_accounts")){
                        List<DynamicMenuModel> subMenu = bottomsubmenumap.get("mnu_accounts");
                ...
                case "UPI":
                    if (bottomsubmenumap.containsKey("mnu_upi")){
                        List<DynamicMenuModel> subMenu = bottomsubmenumap.get("mnu_upi");
                        AppConstants.setSubmenuList(subMenu);
                ...
                case "Service Request":
                    if (bottomsubmenumap.containsKey("mnu_Services")){
                        List<DynamicMenuModel> subMenu = bottomsubmenumap.get("mnu_Services");
                        AppConstants.setSubmenuList(subMenu);
                        AppConstants.account_group=false;
                        AppConstants.upi_group=false;
                ...
                case "Need Help":
                    if (bottomsubmenumap.containsKey("mnu_need_help")){
                        List<DynamicMenuModel> subMenu = bottomsubmenumap.get("mnu_need_help");
                        AppConstants.setSubmenuList(subMenu);
                        AppConstants.account_group=false;
                        AppConstants.upi_group=false;
                        AppConstants.service_group=false;
                ...
                case "Locate US":
                    if (bottomsubmenumap.containsKey("mnu_locate_us")){
                        List<DynamicMenuModel> subMenu = bottomsubmenumap.get("mnu_locate_us");
                        AppConstants.setSubmenuList(subMenu);
                        AppConstants.account_group=false;
                        AppConstants.upi_group=false;
                        AppConstants.service_group=false;
                ...
                case "Cards":
                    if (bottomsubmenumap.containsKey("mnu_cards")){
                        List<DynamicMenuModel> subMenu = bottomsubmenumap.get("mnu_cards");
                        AppConstants.setSubmenuList(subMenu);
                        AppConstants.account_group=false;
                        AppConstants.upi_group=false;
                        AppConstants.service_group=false;
                ...
                case "Bill Pay":
                    try {
                        if (bottomsubmenumap.containsKey("mnu_bbps_finacus")){
                            List<DynamicMenuModel> subMenu = bottomsubmenumap.get("mnu_bbps_finacus");
                            AppConstants.setSubmenuList(subMenu);
                            AppConstants.account_group=false;
                            AppConstants.upi_group=false;
                            AppConstants.service_group=false;
