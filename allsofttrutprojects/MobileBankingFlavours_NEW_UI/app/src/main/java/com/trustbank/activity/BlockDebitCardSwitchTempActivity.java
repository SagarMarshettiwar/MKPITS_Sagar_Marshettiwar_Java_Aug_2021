...
public class BlockDebitCardSwitchTempActivity extends AppCompatActivity implements AlertDialogOkListener {
    ...
    private String debitCardStatus, accNo="", CardStatusSwitch="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(BlockDebitCardSwitchTempActivity.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(BlockDebitCardSwitchTempActivity.this, false);
    ...
    private void inIt() {
        ...
        method = new TrustMethods(BlockDebitCardSwitchTempActivity.this);
        ...
        blockDebitActionList.add(0, "Select Action");
        blockDebitActionList.add("Active");
        blockDebitActionList.add("Deactive");

        ArrayAdapter<String> adapter = new ArrayAdapter<>(BlockDebitCardSwitchTempActivity.this, android.R.layout.simple_spinner_item, blockDebitActionList);
        ...
        spinnerReason.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position != 0) {
                    ...
                    debitCardStatus = (String) parent.getSelectedItem();
                } else {
                    submitCardViewId.setVisibility(View.GONE);
                    ...
                    if (position != 0) {
                        ...
                        if(AppConstants.getSwitchForCardNo().equals("0")) {
                            ...
                            if (status.equalsIgnoreCase("Blocked")) {
                                ...
                                reasonOtherTypeCardViewId.setVisibility(View.GONE);
                                submitCardViewId.setVisibility(View.GONE);
                            } else if (status.equalsIgnoreCase("Temp Blocked")) {
                                btnSubmitCardDetails.setBackgroundColor(TrustMethods.getColorPrimary(BlockDebitCardSwitchTempActivity.this));
                                btnSubmitCardDetails.setClickable(true);
                                reasonTypeCardViewId.setVisibility(View.VISIBLE);
                                submitCardViewId.setVisibility(View.VISIBLE);
                                spinnerReason.setSelection(1);
                                reasonOtherTypeCardViewId.setVisibility(View.GONE);
                                spinnerReason.setClickable(false);
                            } else {
                                btnSubmitCardDetails.setBackgroundColor(TrustMethods.getColorPrimary(BlockDebitCardSwitchTempActivity.this));
                                btnSubmitCardDetails.setClickable(true);
                                reasonTypeCardViewId.setVisibility(View.VISIBLE);
                                submitCardViewId.setVisibility(View.VISIBLE);
                                spinnerReason.setSelection(2);
                                spinnerReason.setClickable(false);
                                reasonOtherTypeCardViewId.setVisibility(View.GONE);
                            ...
                            if(CardStatusSwitch.equalsIgnoreCase("Active")){
                                spinnerReason.setSelection(2);
                            }else {
                                spinnerReason.setSelection(1);
                            }
        ...
        btnSubmitCardDetails.setOnClickListener(v -> {
            ...
            if(AppConstants.getSwitchForCardNo().equals("1")){
                ...
                modeid = spinnerReason.getSelectedItem().toString();
            }else {
                cardNo = debitCardModels.getDebitCardNo();
                modeid = debitCardStatus;
            }
            ...
            if(reasonTypeCardViewId.getVisibility() == View.VISIBLE && modeid.equals("Select Action")){
                TrustMethods.showSnackBarMessage("Please Select Action", debitCardBlockCLId);
            }else {
                if (!TextUtils.isEmpty(cardNo) && !TextUtils.isEmpty(accNo)) {
                    Intent intent = new Intent(BlockDebitCardSwitchTempActivity.this, OtpVerificationActivity.class);
                    intent.putExtra("checkTransferType", "TempblockDebitCardSwitch");
    ...
    private void accNumberSpinner() {
        try {
            accountsArrayList = method.getArrayList(BlockDebitCardSwitchTempActivity.this, "AccountListPref");
        ...
        if (accountsArrayList != null && accountsArrayList.size() > 0) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<>(BlockDebitCardSwitchTempActivity.this, android.R.layout.simple_spinner_item, accountList);
            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                try {
                    if (position != 0) {
                        ...
                        if(AppConstants.getSwitchForCardNo().equals("1")){
                            if (TrustMethods.isSimAvailable(getApplicationContext()) && TrustMethods.isSimVerified(BlockDebitCardSwitchTempActivity.this)) {
                                if (NetworkUtil.getConnectivityStatus(BlockDebitCardSwitchTempActivity.this)) {
                                    new LoadDebitCardSwitchAsyncTask(BlockDebitCardSwitchTempActivity.this, accNo).execute();
                                } else {
                                    TrustMethods.showSnackBarMessage(getResources().getString(R.string.error_check_internet), debitCardBlockCLId);
                                }
                            } else {
                                TrustMethods.displaySimErrorDialog(BlockDebitCardSwitchTempActivity.this);
                            }
                        }else {
                            if (TrustMethods.isSimAvailable(getApplicationContext()) && TrustMethods.isSimVerified(BlockDebitCardSwitchTempActivity.this)) {
                                if (NetworkUtil.getConnectivityStatus(BlockDebitCardSwitchTempActivity.this)) {
                                    new LoadDebitCardDetailsAsyncTask(BlockDebitCardSwitchTempActivity.this, accNo).execute();
                                } else {
                                    TrustMethods.showSnackBarMessage(getResources().getString(R.string.error_check_internet), debitCardBlockCLId);
                                }
                            } else {
    ...
    private class LoadDebitCardDetailsAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(BlockDebitCardSwitchTempActivity.this);
        ...
        protected void onPostExecute(String value) {
            ...
            try {
                ...
                if (debitCardDetailsModelArrayList != null && debitCardDetailsModelArrayList.size() != 0) {
                    ...
                    ArrayAdapter<DebitCardModels> adapter = new ArrayAdapter<>(BlockDebitCardSwitchTempActivity.this, android.R.layout.simple_spinner_item, debitCardDetailsModelArrayList);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    ...
                    if (!this.error.equals("")) {
                        if (TrustMethods.isSessionExpired(errorCode)) {
                            AlertDialogMethod.alertDialogOk(BlockDebitCardSwitchTempActivity.this,
    ...
    private class LoadDebitCardSwitchAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                generateStanRRNModel = TMessageUtil.GetNextStanRrn(BlockDebitCardSwitchTempActivity.this, jsonString,
        ...
        protected void onPostExecute(String value) {
            ...
            try {
                ...
                if (!error.equals("")) {
                    if (TrustMethods.isSessionExpired(errorCode)) {
                        AlertDialogMethod.alertDialogOk(BlockDebitCardSwitchTempActivity.this, getResources().getString(R.string.error_session_expire), "", getResources().getString(R.string.btn_ok), 0, false, alertDialogOkListener);
                    } else {
                        AlertDialogMethod.alertDialogOk(BlockDebitCardSwitchTempActivity.this, "ERROR!!!", error, "Ok",-1,false,alertDialogOkListener);
                    }
                }else {
                    if(debitCardList!= null && !debitCardList.isEmpty()) {
                        debitCardView.setVisibility(View.VISIBLE);
                        ArrayAdapter<String> adapter = new ArrayAdapter<>(BlockDebitCardSwitchTempActivity.this, android.R.layout.simple_spinner_item, debitCardList);
                        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                        spinnerDebitCardId.setAdapter(adapter);
                    }else{
                        debitCardView.setVisibility(View.GONE);
                        AlertDialogMethod.alertDialogOk(BlockDebitCardSwitchTempActivity.this, "", responseMsg.ActCodeDesc.Value, "Ok",-1,false,alertDialogOkListener);
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
            ...
            case android.R.id.home:
                for(DynamicMenuModel menuModel : AppConstants.getParentlist()) {
                    if (menuModel.getMenucode().equalsIgnoreCase("mnu_block_debit_card_switch") || menuModel.getMenucode().equalsIgnoreCase("mnu_block_debit_card_cbs")) {
                        Intent intent = new Intent(BlockDebitCardSwitchTempActivity.this, MenuActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                        finish();
                        return true;
                ...
                if(AppConstants.account_group){
                    Intent intent = new Intent(BlockDebitCardSwitchTempActivity.this, AccountsActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                } else if (AppConstants.upi_group) {
                    Intent intent = new Intent(BlockDebitCardSwitchTempActivity.this, UPIActivityMenu.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                } else if (AppConstants.service_group) {
                    Intent intent = new Intent(BlockDebitCardSwitchTempActivity.this, ServiceRequest.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                } else if (AppConstants.cards_group) {
                    Intent intent = new Intent(BlockDebitCardSwitchTempActivity.this, Cards.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                } else if (AppConstants.locate_us_group) {
                    Intent intent = new Intent(BlockDebitCardSwitchTempActivity.this, LocateUs.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                }else if (AppConstants.need_help_group) {
                    Intent intent = new Intent(BlockDebitCardSwitchTempActivity.this, NeedHelp.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
    ...
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(BlockDebitCardSwitchTempActivity.this);
    }
}
