...
public class NeedHelp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(NeedHelp.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(NeedHelp.this, false);
        setContentView(R.layout.activity_need_help);
        trustMethods =new TrustMethods(NeedHelp.this);
        inIt();
    }
    ...
    private void inIt() {
        try {
            ...
            method = new TrustMethods(NeedHelp.this);
    ...
    private void Submenuselectorfund() {
        TrustMethods.Submenuselectorfund(NeedHelp.this,recyclerAccounts);
    }
    private void staticData(RecyclerView.LayoutManager mLayoutManager) {
        ...
        FundsTransferAdapter fundsTransferAdapter = new FundsTransferAdapter(NeedHelp.this, Arrays.asList(newitemData));
    ...
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(NeedHelp.this);
    }

    private void horizontalRecyclerView() {
        recyclerViewHoriListId = findViewById(R.id.recyclerViewHoriListId);
        trustMethods.horizontalRecyclerView(NeedHelp.this, recyclerViewHoriListId);
    }
}