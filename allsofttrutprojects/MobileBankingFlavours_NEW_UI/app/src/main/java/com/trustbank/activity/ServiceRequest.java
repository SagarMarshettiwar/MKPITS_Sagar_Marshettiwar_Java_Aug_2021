...
public class ServiceRequest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(ServiceRequest.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(ServiceRequest.this, false);
        setContentView(R.layout.activity_service_request);
        trustMethods = new TrustMethods(ServiceRequest.this);
        inIt();
    }
    ...
    private void inIt() {
        ...
        try {
            ...
            method = new TrustMethods(ServiceRequest.this);
    ...
    private void Submenuselectorfund() {
        TrustMethods.Submenuselectorfund(ServiceRequest.this,recyclerAccounts);
    }
    private void staticData(RecyclerView.LayoutManager mLayoutManager) {
        ...
        FundsTransferAdapter fundsTransferAdapter = new FundsTransferAdapter(ServiceRequest.this, Arrays.asList(newitemData));
    ...
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(ServiceRequest.this);
    }

    private void horizontalRecyclerView() {
        recyclerViewHoriListId = findViewById(R.id.recyclerViewHoriListId);
        trustMethods.horizontalRecyclerView(ServiceRequest.this, recyclerViewHoriListId);
    }
}