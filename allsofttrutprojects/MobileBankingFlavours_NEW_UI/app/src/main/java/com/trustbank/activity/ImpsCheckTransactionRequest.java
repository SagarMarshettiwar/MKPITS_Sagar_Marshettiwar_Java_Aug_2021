...
public class ImpsCheckTransactionRequest extends AppCompatActivity implements View.OnClickListener, AlertDialogOkListener, SessionErrorMessageListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(ImpsCheckTransactionRequest.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(ImpsCheckTransactionRequest.this, false);
    ...
    private void init() {
        ...
        trustMethods = new TrustMethods(ImpsCheckTransactionRequest.this);
        ...
        try {
            switch (v.getId()) {
                case R.id.editTextFromDate:
                    trustMethods.datePicker(ImpsCheckTransactionRequest.this, editTextDateFrom);
                    break;
                ...
                case R.id.buttonDisplay:
                    ...
                    if (NetworkUtil.getConnectivityStatus(ImpsCheckTransactionRequest.this)) {
                        new ImpsTransactionRequestDetails(ImpsCheckTransactionRequest.this, date).execute();
                    } else {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                for(DynamicMenuModel menuModel : AppConstants.getParentlist()) {
                    if (menuModel.getMenucode().equalsIgnoreCase("mnu_imps_transction_status")) {
                        Intent intent = new Intent(ImpsCheckTransactionRequest.this, MenuActivity.class);
                ...
                if(AppConstants.account_group){
                    Intent intent = new Intent(ImpsCheckTransactionRequest.this, AccountsActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                } else if (AppConstants.upi_group) {
                    Intent intent = new Intent(ImpsCheckTransactionRequest.this, UPIActivityMenu.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                } else if (AppConstants.service_group) {
                    Intent intent = new Intent(ImpsCheckTransactionRequest.this, ServiceRequest.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                } else if (AppConstants.cards_group) {
                    Intent intent = new Intent(ImpsCheckTransactionRequest.this, Cards.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                } else if (AppConstants.locate_us_group) {
                    Intent intent = new Intent(ImpsCheckTransactionRequest.this, LocateUs.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
                }else if (AppConstants.need_help_group) {
                    Intent intent = new Intent(ImpsCheckTransactionRequest.this, NeedHelp.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    finish();
                    return true;
    ...
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(ImpsCheckTransactionRequest.this);
    }
    ...
    public void onSessionError(String errorMessage) {
        AlertDialogMethod.alertDialogOk(ImpsCheckTransactionRequest.this, getResources().getString(R.string.error_session_expire),
                "",
    ...
    private class ImpsTransactionRequestDetails extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ImpsCheckTransactionRequest.this);
            ...
            try {
                ...
                if (!this.error.equals("")) {
                    ...
                    if (TrustMethods.isSessionExpired(errorCode)) {
                        AlertDialogMethod.alertDialogOk(ImpsCheckTransactionRequest.this, getResources().getString(R.string.error_session_expire), "", getResources().getString(R.string.btn_ok), 0, false, alertDialogOkListener);
                    } else {
                    ...
                    if (impsTransactionRequestModelList != null && impsTransactionRequestModelList.size() != 0) {
                        ImpsTransactionRequestEnquiryAdapter lastFiveTransactionCBSAdapter = new ImpsTransactionRequestEnquiryAdapter(ImpsCheckTransactionRequest.this, impsTransactionRequestModelList, ImpsCheckTransactionRequest.this);
    ...
    private void horizontalRecyclerView() {
        ...
        trustMethods.horizontalRecyclerView(ImpsCheckTransactionRequest.this, recyclerViewHoriListId);
    }
}
