...
public class Cards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (AppConstants.IS_CHECK_ACCESS_BROKEN) {
                if (savedInstanceState != null) {
                    ...
                    if (currentPID != savedInstanceState.getString(AppConstants.PID)) {
                        ...
                        TrustMethods.naviagteToSplashScreen(Cards.this);
                    }
                }
            }
        } catch (Exception e) {
        ...
        SetTheme.changeToTheme(Cards.this, false);
        setContentView(R.layout.activity_cards);
        trustMethods=new TrustMethods(Cards.this);
        inIt();
    }
    ...
    private void inIt() {
        ...
        try {
            ...
            method = new TrustMethods(Cards.this);
    ...
    private void Submenuselectorfund() {
        TrustMethods.Submenuselectorfund(Cards.this,recyclerAccounts);
    }
    private void staticData(RecyclerView.LayoutManager mLayoutManager) {
        ...
        FundsTransferAdapter fundsTransferAdapter = new FundsTransferAdapter(Cards.this, Arrays.asList(newitemData));
    ...
    public void onBackPressed() {
        TrustMethods.showBackButtonAlert(Cards.this);
    }

    private void horizontalRecyclerView() {
        recyclerViewHoriListId = findViewById(R.id.recyclerViewHoriListId);
        trustMethods.horizontalRecyclerView(Cards.this, recyclerViewHoriListId);
    }
}